...
const NovoLivro = () => {
  ...
  const incluir = async (event: FormEvent<HTMLFormElement>) => {
    ...
    // Validar os dados antes de fazer a requisição
    if (livro.titulo && livro.resumo && livro.autores.length > 0) {
      try {
      ...
      console.error('Dados do livro inválidos. Certifique-se de preencher todos os campos.');
    }
  };
